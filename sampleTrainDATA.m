...
IMP(:,:,2)  = xlsread('Series7');
IMP(:,:,3)  = xlsread('Series8');
IMP(:,:,4)  = xlsread('Series9');
IMP(:,:,5)  = xlsread('Series10');
IMP(:,:,6)  = xlsread('Series11');
IMP(:,:,7)  = xlsread('Series12');
IMP(:,:,8)  = xlsread('Series13');
IMP(:,:,9)  = xlsread('Series14');
IMP(:,:,10) = xlsread('Series15');
IMP(:,:,11) = xlsread('Series16');
IMP(:,:,12) = xlsread('Series17');
IMP(:,:,13) = xlsread('Series18');
IMP(:,:,14) = xlsread('Series19');
IMP(:,:,15) = xlsread('Series20');
IMP(:,:,16) = xlsread('Series21');
IMP(:,:,17) = xlsread('Series22');
IMP(:,:,18) = xlsread('Series23');
IMP(:,:,19) = xlsread('Series24');
IMP(:,:,20) = xlsread('Series25');
IMP(:,:,21) = xlsread('Series26');
IMP(:,:,22) = xlsread('Series27');
IMP(:,:,23) = xlsread('Series28');
IMP(:,:,24) = xlsread('Series29');
IMP(:,:,25) = xlsread('Series30');
IMP(:,:,26) = xlsread('Series31');
IMP(:,:,27) = xlsread('Series32');
IMP(:,:,28) = xlsread('Series33');
IMP(:,:,29) = xlsread('Series34');
IMP(:,:,30) = xlsread('Series35');
IMP(:,:,31)= xlsread('Series38');
